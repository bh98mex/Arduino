...
/////////////////////////////////////////
 // initialize the Servo Motor as an output:
  pinMode(9,OUTPUT);
  // initialize the pushbutton pin as an input:
  pinMode(buttonPin, INPUT);
  //process to be carried out on button push:
  attachInterrupt(digitalPinToInterrupt(9),unlockdoor,OUTPUT);
  ////////////////////////////////////////////////////
lcd.begin(16,2);
